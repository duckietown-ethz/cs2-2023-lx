...
fork: `<your_username>/cs2-2023-lx`

Then clone your new repository, replacing your GitHub username in the command below,

    git clone -b main git@github.com:<your_username>/cs2-2023-lx
...
Specify a new remote upstream repository,
    ...
    git remote add upstream https://github.com/duckietown-ethz/cs2-2023-lx
